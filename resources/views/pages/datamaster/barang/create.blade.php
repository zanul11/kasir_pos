            ...
            <div class="widget-content widget-content-area">
                ...
                <div class="row">
                    <div class="col-lg-12 col-12 ">
                        ...
                        @endisset
                        <form
                            action="{{ request()->routeIs('barang.create')?route('barang.store') : route('barang.update',$barang) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-4 col-md-12 col-xs-12">
                                    ...
                                    <select class="form-control select2" data-live-search="false" name="satuan_id">
                                        ...
                                        <option value="{{ $dt->id }}" {{ old('satuan_id',$barang->
                                            satuan_id??'')==$dt->id ? 'selected' : '' }}>
                                            {{ $dt->nama }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-lg-4 col-md-12 col-xs-12 form-group">
                                    <p>Stok Minimal</p>
                                    <input id="stok_min" type="number" name="stok_min" class="form-control"
                                        value="{{ old('stok_min',$barang->stok_min??'') }}" required>
                                </div>
                                <div class="col-lg-4 col-md-12 col-xs-12 form-group">
                                    <p>Stok Awal</p>
                                    <input id="stok_awal" type="number" name="stok_awal" class="form-control"
                                        value="{{ old('stok_awal',$barang->stok_awal??'') }}" {{
                                        request()->routeIs('barang.create')?'required' : 'readonly' }}>
                                </div>
                                <div class="col-lg-12 col-md-12 col-xs-12 form-group">
                                    <p>Harga Jual</p>
                                    <input id="harga_jual" type="text" name="harga_jual"
                                        class="format-uang form-control"
