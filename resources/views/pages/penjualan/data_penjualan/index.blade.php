        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 user-profile layout-spacing">
            <div class="widget-content widget-content-area">
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <a href="{{route('data_penjualan.export')}}" class="mt-2 edit-profile2" style="float: right; margin-left: 10px;">
                            <i data-feather="file"></i></a> <a href="{{route('barang_keluar.create')}}" class="mt-2 edit-profile">
...
<script>
    ...
    $('#datatable').DataTable({
        ...
        ordering: false,
        searching: false,
        ajax: "{!! route('data_penjualan.data') !!}",
        columns: [{
                data: 'id',
                name: 'id',
            ...
            },
            {
                ...
                data: 'total_tagihan_penjualan',
                name: 'total_tagihan_penjualan'
            },
            {
                data: 'barang_detail',
                name: 'barang_detail',
